...
variable "os_auth_url" {
  ...
  default = "https://identity.example.com:5000/v3"
}
...
variable "golden_image_uuid" {
  ...
  default = "wwww-wwww-wwww-wwww-wwwwwwwwwwww"
}
...
build {
  ...
  provisioner "shell-local" {
    command = "echo '========================================' && echo 'Packer build completed successfully!' && echo '========================================' && echo 'Instance Name: win2022-server' && echo 'Volume Name: win2022-data-volume' && echo '========================================'"
  }
}
